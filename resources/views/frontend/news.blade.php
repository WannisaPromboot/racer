                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8" >
                            <div class="welcome_docmed_info">
                                ...
                                <a href="{{url('detail-news')}}/{{$item->id_new}}" class="boxed-btn3-white-2">{{Session::get('langfrontend')=='th'?'ดูเพิ่มเติม':'See more details '}}<i class="fas fa-angle-right" aria-hidden="true"></i></a>
                            </div>
                        </div>
                    </div>
                    <br><br>
