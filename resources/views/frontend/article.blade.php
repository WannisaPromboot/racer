      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            {{-- <h1 class="mb-0 bread">บทความ</h1>
            <p class="breadcrumbs"><span class="mr-2"><a href="{{url('/')}}">หน้าหลัก</a></span>/ <span>บทความ</span></p> --}}
          </div>
        </div>
      </div>
    </div>
                ...
                <div class="row">
                    @foreach($data as $item)
                            <div class="col-6">
                                ...
                                <div class="row" id="" style="text-align: center">
                                    <div class="col-12">
                                        <a href="{{url('/detail-article')}}/{{$item->id_blog}}" class="boxed-btn3-white-2">{{Session::get('langfrontend')=='th'?'ดูเพิ่มเติม':'See more details '}} <i class="fas fa-angle-right" aria-hidden="true"></i></a>
                                    </div>
                                </div>
                            </div>
