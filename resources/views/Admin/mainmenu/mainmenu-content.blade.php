...
<div class="row">
    ...
    <div class="col-6 text-right">
        <a href="{{url('addmainmenu')}}" class="btn" style="background-color: #03dc74 !important;color:white !important;">{{Session::get('lang')=='th'?'+ เพิ่มเมนูหลัก ' :'+ Add Category'}}</a>
    </div> 
</div>     
<!-- end page title -->
            ...
            <div class="card-body">
                ...
                <table id="table" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                    ...
                    <tr>
                        ...
                        <th>{{Session::get('lang')=='th'?'ไม่แสดง' :'Not Display'}}</th>
                        <th>{{Session::get('lang')=='th'?'เมนูภาษาไทย' :'Category (Thailand)'}}</th>
                        <th>{{Session::get('lang')=='th'?'เมนูภาษาอังกฤษ' :'Category (English)'}}</th>
                        <th>{{Session::get('lang')=='th'?'เมนูภาษาจีน' :'Category (Chainese)'}}</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{$i}}</td>
                            <td><input type="checkbox" class="form-control check" ref="{{$item->menu_id}}" {{$item->status ==1 ? 'checked':''}}></td>
                            <td>{{$item->menu_th}}</td>
                            <td>{{$item->menu_en}}</td>
                            <td>{{$item->menu_ch}}</td>
                            <td>
                            ...
                            <td>
                                <a href="{{url('editmainmenu/'.$item->menu_id.'')}}" class="btn btn-warning btn-sm">{{Session::get('lang')=='th'?'แก้ไข' :'Edit'}}</a>
                            </td>
                        </tr>
