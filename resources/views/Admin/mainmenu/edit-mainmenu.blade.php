...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <div id="edit">
                    <form action="{{url('updatemainmenu')}}"  method="post" id="editmain">            
                        @csrf
                        ...
                        <div data-repeater-list="outer-group" class="outer">
                            <div data-repeater-item class="outer"> 
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <input type="text" class="form-control" name="menu_th" value="{{$item->menu_th}}" required>
                                    </div>
                                </div>
                                <br>
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <input type="text" class="form-control" name="menu_en" value="{{$item->menu_en}}" required>
                                    </div>
                                </div>
                                <br>
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <input type="text" class="form-control" name="menu_ch" value="{{$item->menu_ch}}" required>
                                    </div>
                                </div>
                                <br>
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <input type="number" class="form-control" name="category_id" value="{{$item->category_id}}" required>
                                    </div>
                                </div>
                                <div class="row mt-5">
 ...
 function save(formname){
    ...
    Swal.fire({
        ...
        cancelButtonText: 'ไม่ใช่',
            ...
            if (result.value) {
                    window.location.href = "{{ url('mainmenucontent')}}";
                }
        });
    }
