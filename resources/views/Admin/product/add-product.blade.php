                    ...
                    <div data-repeater-list="outer-group" class="outer">
                        <div data-repeater-item class="outer"> 
                            ...
                            <div class="row" >
                                ...
                                <div class="col-3">
                                    <input type="number" class="form-control normalprice" onchange="checknumber(this.value,'normalprice')" name="product_normal_price" min="0" required>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm">
                                    <textarea type="texe" class="form-control" id="product_direction_th" name="product_direction_th" ></textarea>
                                </div>
                            </div>
                            <br>
                            <div class="row">
                                ...
                                <div class="col-sm">
                                    <textarea type="texe" class="form-control" id="product_direction_en" name="product_direction_en" ></textarea>
                                </div>
                            </div>
                            <br>
                            <div class="row">
                                ...
                                <div class="col-sm">
                                    <textarea type="texe" class="form-control" id="product_caution_th" name="product_caution_th" ></textarea>
                                </div>
                            </div>
                            <br>
                            <div class="row">
                                ...
                                <div class="col-sm">
                                    <textarea type="texe" class="form-control" id="product_caution_en" name="product_caution_en" ></textarea>
                                </div>
                            </div>
                            <br>
                            {{-- spec --}}
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm">
                                    <textarea type="texe" class="form-control" id="product_spec_th" name="product_spec_th" ></textarea>
                                </div>
                            </div>
                            <br>
                            <div class="row">
                                ...
                                <div class="col-sm">
                                    <textarea type="texe" class="form-control" id="product_spec_en" name="product_spec_en" ></textarea>
                                </div>
                            </div>
                            <br>
                            <div class="row">
                                ...
                                <div class="col-sm">
                                    <textarea type="texe" class="form-control" id="product_extra_th" name="product_extra_th" ></textarea>
                                </div>
                            </div>
                            <br>
                            <div class="row">
                                ...
                                <div class="col-sm">
                                    <textarea type="texe" class="form-control" id="product_extra_en" name="product_extra_en" ></textarea>
                                </div>
                            </div>
                            <br>
                            <div class="row">
